...
export const AscensionCard: React.FC<AscensionCardProps> = ({ onEnter, onHover, isDesktop = false }) => {
    const content = (
        <div className="relative z-10 p-6 w-full flex flex-col items-center h-full justify-center">
            ...
            <div className={`space-y-4 w-full text-left pl-8 mb-10 flex-grow ${isDesktop ? 'opacity-80 group-hover:opacity-100 transition-opacity' : 'opacity-100'} border-l-2 border-indigo-500/50 ml-6`}>
