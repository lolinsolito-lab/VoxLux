                    ...
                    {questions.map((q, idx) => (
                        <div key={q.id} className="group">
                            <motion.button
                                ...
                                className={`w-full text-left p-6 rounded-2xl flex justify-between items-center transition-all duration-300 border ${openIndex === idx
                                        ? 'bg-zinc-900/80 border-lux-gold/30 shadow-[0_0_30px_rgba(228,197,114,0.05)]'
                                        : 'bg-zinc-950/50 border-white/5 hover:bg-zinc-900 hover:border-white/10'
                                    }`}
                            >
                            ...
                            <AnimatePresence>
                                {openIndex === idx && (
                                    ...
                                    >
                                        <div className="p-6 pt-2 text-zinc-400 leading-relaxed border-l border-lux-gold/10 ml-6">
